...
ActiveRecord::Schema.define(version: 20151226194232) do
  ...
  create_table "chefs", force: :cascade do |t|
    ...
    t.string   "chef_image_file_name"
    t.string   "chef_image_content_type"
    t.integer  "chef_image_file_size"
    t.datetime "chef_image_updated_at"
  end
